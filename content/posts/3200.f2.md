...
draft: false
summary: "CUHKSZ 大二课程 CSC3200 关于树、堆、图的相关知识期末总结"
categories: 
- SDS
tags: 
- CSC3200
...
- 注意：怎么旋转不是猜出来的，**失衡只可能发生在插/删点到根的路径上**。我们需要一个 LminusR() 函数来记录**平衡系数**，如 `height(n->left) - height(n->right)` ≤ ±1就正常，否则就失衡，需要重平衡。
